...
function main() {
  ...
  function checkTouches(event){
    ...
    if(TouchY >= 350 && (TouchX >= 150 && TouchX <= 350 )){ //Accelerate
    ...
    else if(TouchY < 500 && (TouchX >= 150 && TouchX <= 350 )){ //Reverse
    ...
    else if(TouchX > 350 && (TouchY > 500)) //Go Right
    {
    ...
    else if(TouchX > 350 && (TouchY < 500)) //Go RightForward
    {
    ...
    else if(TouchX < 150 && (TouchY < 500)) //Go LeftForward
    {
    ...
    else if(TouchX < 150 && (TouchY > 500)) //Go Left
    {
